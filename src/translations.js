...
export const translations = {
  ...
  ar: {
      ...
      pillars: [
        {
          ...
          body:
            "صوت الكاتب مقدّس. أقرأ العمل ثلاث مرات قبل الترجمة — مرة كقارئ، ومرة كناقد، ومرة كمترجم. عندها يسكن الصوت فيّ، فأحمله إلى العربية.",
        },
        {
          icon: "Globe",
    ...
    footer: {
      tagline: "مترجم أدبي — العربية · الإنجليزية · الفرنسية",
