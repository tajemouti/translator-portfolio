...
export const translations = {
  ...
  ar: {
    ...
    nav: {
      logo: "أجراس تاجموتي",
      links: ["عن المترجمة", "الفلسفة", "معرض الترجمة", "المسيرة", "التواصل"],
      anchors: ["about", "philosophy", "showroom", "journey", "contact"],
      languageLabel: "اللغة",
    },

    hero: {
      tagline: "مترجمة أدبية",
    ...
    about: {
      label: "عن المترجمة",
      title: "عقل المترجمة",
      portrait: "أجراس تاجموتي",
      intro:
        "اسمي أجراس تاجموتي. مترجمة أدبية ثلاثية اللغة مقيمة في المغرب، أعمل على ملتقى العوالم الأدبية العربية والإنجليزية والفرنسية.",
      body: [
        "ترجمتُ رواية «شعرة الحمامة» للكاتب محمد مسعود مرسي — الفائز بجائزة دوروثي هيويت 2025 — من الإنجليزية إلى العربية. وأعمل حالياً على الترجمة العربية لروايته الثانية «قصر الملائكة».",
      ...
      milestones: [
        {
          year: "٢٠٢٥",
          type: "achievement",
          title: "جائزة دوروثي هيويت — مترجمة",
